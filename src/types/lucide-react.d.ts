declare module 'lucide-react' {
  // Unauthenticated typing for rapid development.
  // These are React components; `any` allows both JSX usage and passing
  // the component reference where a ReactNode/ComponentType is expected.
